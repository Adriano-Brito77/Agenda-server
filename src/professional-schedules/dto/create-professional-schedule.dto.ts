...
const createProfessionalScheduleBodySchema = z.object({
...
class CreateProfessionalScheduleDto extends createZodDto(
  createProfessionalScheduleBodySchema,
) {}

export { createProfessionalScheduleBodySchema, CreateProfessionalScheduleDto };
